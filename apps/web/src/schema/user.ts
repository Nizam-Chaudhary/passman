import { masterPasswordSchema, verifyUserEmailBodySchema } from "@passman/schema/api";
...
export type CreateMasterPasswordForm = z.infer<typeof createMasterPasswordFormSchema>;

// Update master password
export const updateMasterPasswordFormSchema = createMasterPasswordFormSchema;

export type UpdateMasterPasswordForm = z.infer<typeof updateMasterPasswordFormSchema>;
