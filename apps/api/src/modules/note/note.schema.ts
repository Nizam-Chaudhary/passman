...
export const addNoteSchema = z
  .object({
    ...
    title: z.string().min(1, "Title is required").describe("Title of the note"),
    content: z.string().nullable().optional().describe("Content of the note"),
  })
...
export type DeleteMultipleNotesBody = z.infer<typeof deleteMultipleNotesBodySchema>;
