...
export const requestDurationSummary = meter.createHistogram("http_request_duration_summary", {
...
export const requestSizeHistogram = meter.createHistogram("http_request_size_bytes", {
  description: "Size of incoming HTTP requests",
  unit: "bytes",
});

// 5. Histogram: Response payload size
export const responseSizeHistogram = meter.createHistogram("http_response_size_bytes", {
